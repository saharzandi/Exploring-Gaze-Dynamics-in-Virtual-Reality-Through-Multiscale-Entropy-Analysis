...
mse_results_path = "C:/Users/se006/OneDrive/Documents/Sahar/PhD/MDPI/Codes/Output/MSE_results.csv"
...
for task in task_types:
    ...
    title_text = f'(a): MES for task type: {task} - Horizontal Gaze Position (column x)'
    ...
    # Save the figure
    plt.savefig(f"C:/Users/se006/OneDrive/Documents/Sahar/PhD/MDPI/Codes/Output/x/a_MSE_{task}.png", bbox_inches='tight')
    plt.close()
